...
const modules = import.meta.glob(
  "/src/assets/projects/fitzone/**/*.{jpg,JPG,jpeg,JPEG,png,PNG,webp,WEBP,avif,AVIF,gif,GIF}",
    ...
    <div className="project">
      <div className="container">
        <header className="project-header">
          <h1 className="h2">FitZone</h1>
          <p className="muted">
            Gym management web app for class schedules, memberships, and workout updates — built with PHP, HTML, CSS, and JavaScript. Includes an admin panel.
          </p>
        </header>

        {images.length ? (
          <ul className="masonry" aria-label="FitZone screenshots">
            {images.map((src,i)=>(
          ...
          <p className="muted" style={{textAlign:"center",margin:"24px 0"}}>
            No screenshots found in <code>src/assets/projects/fitzone/</code>.
          </p>
        )}

        <div className="project-actions">
          {/* No public site yet — omit the Visit button or add when ready */}
