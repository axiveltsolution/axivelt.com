...
import "./GadgetHub.css";

const modules = import.meta.glob(
  "/src/assets/projects/gadgethub/**/*.{jpg,JPG,jpeg,JPEG,png,PNG,webp,WEBP,avif,AVIF,gif,GIF}",
...
export default function GadgetHub() {
    ...
    <div className="project">
      <div className="container">
        <header className="project-header">
          <h1 className="h2">GadgetHub</h1>
          <p className="muted">
            Gadget shopping platform with price comparison, stock checks, and order tracking. Built with React + Node.js for a fast, reliable experience.
          </p>
        </header>

        {images.length ? (
          <ul className="masonry" aria-label="GadgetHub screenshots">
            {images.map((src,i)=>(
          ...
          <p className="muted" style={{textAlign:"center",margin:"24px 0"}}>
            No screenshots found in <code>src/assets/projects/gadgethub/</code>.
          </p>
        )}

        <div className="project-actions">
          {/* Add a live URL when available */}
