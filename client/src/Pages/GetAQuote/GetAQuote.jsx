  ...
  return (
    <>
      <HeroSection
        ...
        subtitle="Request a quote for custom software solutions, enterprise applications, or inventory systems powered by Axivelt."
        ...
        <form
          ...
          <div className="quote-field">
            ...
            <textarea
              name="details"
              rows="6"
              placeholder="What software solution do you need? (inventory system, CRM, business automation, web/mobile app, e-commerce platform). What problems are you trying to solve? What features are important? Any integration requirements or specific deadlines?"
              required
            />
            <p className="field-instruction">
              The more details you provide, the more accurate our quote will be.
              Include your business goals, current challenges, desired features,
              number of users, and any technical requirements or existing
          ...
          <div className="quote-websites">
            ...
            />
            <p className="field-instruction">
              Share links to software, apps, or websites with features you like
              <span style={{ color: "#ff4757" }}> and hit enter.</span> Only
              valid URLs will be added.
            </p>
